...
export const translations = {
  en: {
    ...
    followUp: {
      ...
      upcomingMeetingsAlt: "UPCOMING MEETINGS",
      taskCompletion: "TASK COMPLETION",
      weeklyActivity: "Weekly Activity",
      financialOverview: "Financial Overview",
      expenses: "EXPENSES",
      ...
      netBalance: "NET BALANCE",
      loss: "Loss",
      teamProjectGroup: "Team Project Group",
      meetingRoom: "Meeting Room",
      groupChat: "Group Chat",
      groupChatDescription: "Company-wide discussion",
  ...
  ar: {
    ...
    followUp: {
      unreadEmail: "البريد غير المقروء",
      activeTasks: "المهام النشطة",
      upcomingMeetings: "الاجتماعات القادمة",
      upcomingMeetingsAlt: "الاجتماعات القادمة",
      taskCompletion: "إنجاز المهام",
      weeklyActivity: "النشاط الأسبوعي",
      financialOverview: "النظرة المالية",
      expenses: "المصروفات",
      ...
      netBalance: "الرصيد الصافي",
      loss: "خسارة",
      teamProjectGroup: "مجموعة مشروع الفريق",
      meetingRoom: "قاعة الاجتماعات",
      groupChat: "المحادثة الجماعية",
      groupChatDescription: "نقاش على مستوى الشركة",
    ...
    careers: {
      title: "فرص العمل",
      subtitle: "تصفح الوظائف من مكاتب شركائنا الموثوقين. قدم مباشرة واتخذ الخطوة التالية في مسيرتك المهنية.",
